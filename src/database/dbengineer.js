...
export const EngineerDatabase = {

  get() {
    return new Promise((resolve, reject) => {
      try {
        EngineerSchema.find({}, (error, data) => {
          if (error) {
  ...
  create(postobject) {
    return new Promise((resolve, reject) => {
      try {
        EngineerSchema.create(postobject, (error, resposne) => {
          if (error) {
  ...
  update(_id, obj) {
    return new Promise((resolve, reject) => {
      try {
        EngineerSchema.findOneAndUpdate(_id, obj, { new: true }, (error, resposne) => {
          if (error) {
